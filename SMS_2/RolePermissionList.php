...
color:#597A41;
	...
	<div id="bar">
     ...
     require('conn.php');
      ...
      $result = mysqli_query($conn, "SELECT * FROM role_permission");
      ?>
	  <form>
      ...
      <tbody>
        <?php
		  ...
		  while( $row = mysqli_fetch_assoc( $result)){
			  ...
			  $per=$row['permissionid'];
			  $q1="Select * from permissions where permissionid = '".$per."'";
		 ...
		 if ($btn == true){
			 $id = $_REQUEST['edit'];
			 $_SESSION['unq3'] = $id;
			 echo '<script type="text/javascript">window.location = "RolePermission.php" </script>';
		 }
		 if ($btn1){
			 $id = $_REQUEST['delete'];
			 $sql1 = "delete from role_permission where id = '".$id."'";
	  ...
	  <input type='submit' name='btn3' value='Create new Role Permission' style= "position:absolute; left:460px;">
	  <?php
