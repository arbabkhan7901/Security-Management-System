...
color:#597A41;
	...
	<div id="bar">
     ...
     require('conn.php');
      ...
      <tbody>
        <?php
		 ...
		 if ($btn == true){
			$id = $_REQUEST['edit'];
			$_SESSION['unq2'] = $id;
			echo '<script type="text/javascript">window.location = "PermissionManagement.php" </script>';
		 }
		 if ($btn1){
			 $id = $_REQUEST['delete'];
			 $sql1 = "delete from permissions where permissionid = '".$id."'";
	  ...
	  <input type='submit' name='btn3' value='Create new Permission' style= "position:absolute; left:370px;">
	  <?php
