...
<head>
    ...
    <script>
        function Main() {
            ...
            var u_arr = SecurityManager.GetAllRoles();
                ...
                for (var j = 0; j < 5; j++) {
                    ...
                    if (j == 3) {
                        ...
                        newText.onclick = function () {
                            var edit_user = SecurityManager.GetRoleById(this.id);
                            ...
                            sBtn.onclick = function () {
                                ...
                                SecurityManager.SaveRole(edit_user, function () { alert("user has been edited") }, function () { alert("user has not been edited") });
                            };
                        };
                        newCell.style.border = '1px solid black';
                    }
                    if (j == 4) {
                        ...
                        newText.onclick = function () {
                            ...
                            if (agree) {
                                SecurityManager.DeleteRole(this.id, function () { alert("Record Deleted"); }, function () { alert("Record can not deleted"); });
            ...
            save_btn.onclick = function () {
                ...
                if (flag == true) {
                    SecurityManager.SaveRole(userObj, function () { alert("user has been created") }, function () { alert("user has not been created") });
...
<body onload="Main();">
    ...
    <div class="div1">
        ...
        <form>
            <br><input id="role" type="text" class="box" placeholder="Role Name" required>
            <br><br>
